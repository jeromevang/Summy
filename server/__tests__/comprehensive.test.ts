...
import { errorMonitor } from '../services/error-handler.js';
  ...
  describe('Model Testing Workflow', () => {
    ...
    it('should handle combo testing workflow', async () => {
      ...
      if (models.length >= 2) {
        ...
        console.log('✅ Combo testing workflow test passed');
      }
    });
  });
...
describe('Performance Tests', () => {
  describe('Database Performance', () => {
    it('should handle concurrent database operations', async () => {
      ...
      console.log('✅ Concurrent database operations test passed');
    });
    ...
    it('should handle large result sets efficiently', async () => {
      ...
      console.log(`✅ Large result set test passed (${duration}ms)`);
    });
  });
  ...
  describe('Caching Performance', () => {
    it('should serve cached responses faster than fresh queries', async () => {
      ...
      console.log(`✅ Caching performance test passed (${duration1}ms → ${duration2}ms)`);
    });
  });
});
...
describe('Load Tests', () => {
  it('should handle high concurrent load', async () => {
    ...
    console.log(`✅ Load test passed: ${totalRequests} requests in ${totalTime}ms (avg: ${avgResponseTime}ms)`);
