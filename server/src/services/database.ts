...
-- ============================================================
-- RAG SYSTEM (Moved to rag-server/data/rag.db)
-- ============================================================
-- RAG data is now stored in the RAG server's own SQLite database.
-- This separation allows the RAG server to operate independently.
...
class DatabaseService {
  ...
  // ============================================================
  // RAG SYSTEM - MOVED TO rag-server
  // ============================================================
  // RAG data storage has been moved to the RAG server's own SQLite database.
  // The main server proxies all RAG requests to: http://localhost:3002/api/rag/*
  // See: rag-server/src/services/database.ts

  // ============================================================
  // RAG CONFIG (Still needed for UI settings sync)
  // ============================================================

  // Get RAG configuration (proxied from RAG server config, cached here for UI)
  getRAGConfig(): {
    lmstudio: {
      model: string | null;
