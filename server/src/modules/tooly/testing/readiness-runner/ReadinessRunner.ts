...
export class ReadinessRunner {
  constructor(private _settings: RunnerSettings, private _broadcast?: BroadcastFn) {}
  ...
  private async runSingleTest(test: any, _modelId: string, _isDualMode: boolean): Promise<TestRunResult> {
