...
export function evaluateInstructionFollowing(response: any, toolCalls: any[]): ProbeEvaluation {
...
export function evaluateContextCoherence(response: any, toolCalls: any[]): ProbeEvaluation {
...
export function evaluateBasicReasoning(response: any, toolCalls: any[]): ProbeEvaluation {
